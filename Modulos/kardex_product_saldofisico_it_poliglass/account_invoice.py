	...
	def do_rebuild(self):
		self.env.cr.execute("""
			...
			create view detalle_simple_fisico_total_d_poliglass as (
					...
					select ubicacion as almacen, product_id as producto, pt.categ_id as categoria, unidad as unidad,
		...
		view_id = self.env.ref('kardex_product_saldofisico_it_poliglass.view_kardex_fisico_d_poliglass',False)
		return {
